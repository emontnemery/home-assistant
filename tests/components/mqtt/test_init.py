...
async def test_mqtt_connects_on_home_assistant_mqtt_setup(
    hass, mqtt_client_mock, mqtt_mock_entry
):
...
async def test_mqtt_disconnects_on_home_assistant_stop(hass, mqtt_mock_entry):
...
async def test_publish(hass, mqtt_mock_entry):
...
async def test_command_template_variables(hass, mqtt_mock_entry):
...
async def test_service_call_without_topic_does_not_publish(hass, mqtt_mock_entry):
...
async def test_service_call_with_template_topic_renders_template(hass, mqtt_mock_entry):
...
async def test_service_call_with_bad_template(hass, mqtt_mock_entry):
...
async def test_service_call_with_payload_doesnt_render_template(hass, mqtt_mock_entry):
    """Test the service call with unrendered template.
...
async def test_service_call_with_ascii_qos_retain_flags(hass, mqtt_mock_entry):
...
async def test_receiving_non_utf8_message_gets_logged(
    hass, mqtt_mock_entry, calls, record_calls, caplog
):
...
async def test_all_subscriptions_run_when_decode_fails(
    hass, mqtt_mock_entry, calls, record_calls
):
...
async def test_subscribe_topic(hass, mqtt_mock_entry, calls, record_calls):
...
async def test_subscribe_topic_non_async(hass, mqtt_mock_entry, calls, record_calls):
...
async def test_subscribe_bad_topic(hass, mqtt_mock_entry, calls, record_calls):
    """Test the subscription of a topic."""
    await mqtt_mock_entry()
    with pytest.raises(HomeAssistantError):
...
async def test_subscribe_deprecated(hass, mqtt_mock_entry):
...
async def test_subscribe_deprecated_async(hass, mqtt_mock_entry):
...
async def test_subscribe_topic_not_match(hass, mqtt_mock_entry, calls, record_calls):
...
async def test_subscribe_topic_sys_root(hass, mqtt_mock_entry, calls, record_calls):
...
async def test_subscribe_special_characters(hass, mqtt_mock_entry, calls, record_calls):
...
async def test_subscribe_same_topic(hass, mqtt_client_mock, mqtt_mock_entry):
    """
...
async def test_unsubscribe_race(hass, mqtt_client_mock, mqtt_mock_entry):
    """Test not calling unsubscribe() when other subscribers are active."""
    mqtt_mock = await mqtt_mock_entry()
    # Fake that the client is connected
    mqtt_mock().connected = True
...
async def test_logs_error_if_no_connect_broker(
    hass, caplog, mqtt_mock_entry, mqtt_client_mock
):
...
async def test_handle_mqtt_on_callback(hass, caplog, mqtt_mock_entry, mqtt_client_mock):
...
async def test_handle_message_callback(hass, caplog, mqtt_mock_entry, mqtt_client_mock):
...
async def test_custom_birth_message(hass, mqtt_client_mock, mqtt_mock_entry):
...
async def test_default_birth_message(hass, mqtt_client_mock, mqtt_mock_entry):
    """Test sending birth message."""
    await mqtt_mock_entry()
    birth = asyncio.Event()
...
async def test_no_birth_message(hass, mqtt_client_mock, mqtt_mock_entry):
...
async def test_delayed_birth_message(
    hass, mqtt_client_mock, mqtt_config, mqtt_mock_entry
):
...
async def test_custom_will_message(hass, mqtt_client_mock, mqtt_mock_entry):
    """Test will message."""
    await mqtt_mock_entry()
...
async def test_default_will_message(hass, mqtt_client_mock, mqtt_mock_entry):
    """Test will message."""
    await mqtt_mock_entry()
...
async def test_no_will_message(hass, mqtt_client_mock, mqtt_mock_entry):
    """Test will message."""
    await mqtt_mock_entry()
...
async def test_message_callback_exception_gets_logged(hass, caplog, mqtt_mock_entry):
...
async def test_mqtt_ws_subscription(hass, hass_ws_client, mqtt_mock_entry):
...
async def test_mqtt_ws_subscription_not_admin(
    hass, hass_ws_client, mqtt_mock_entry, hass_read_only_access_token
):
...
async def test_dump_service(hass, mqtt_mock_entry):
...
async def test_mqtt_ws_remove_discovered_device(
    hass, device_reg, entity_reg, hass_ws_client, mqtt_mock_entry
):
...
async def test_mqtt_ws_get_device_debug_info(
    hass, device_reg, hass_ws_client, mqtt_mock_entry
):
...
async def test_debug_info_multiple_devices(hass, mqtt_mock_entry):
...
async def test_debug_info_multiple_entities_triggers(hass, mqtt_mock_entry):
...
async def test_debug_info_non_mqtt(hass, device_reg, entity_reg, mqtt_mock_entry):
...
async def test_debug_info_wildcard(hass, mqtt_mock_entry):
    """Test debug info."""
    await mqtt_mock_entry()
    config = {
...
async def test_debug_info_filter_same(hass, mqtt_mock_entry):
...
async def test_debug_info_same_topic(hass, mqtt_mock_entry):
    """Test debug info."""
    await mqtt_mock_entry()
    config = {
        "device": {"identifiers": ["helloworld"]},
...
async def test_debug_info_qos_retain(hass, mqtt_mock_entry):
    """Test debug info."""
    await mqtt_mock_entry()
    config = {
        "device": {"identifiers": ["helloworld"]},
...
async def test_publish_json_from_template(hass, mqtt_mock_entry):
...
async def test_subscribe_connection_status(hass, mqtt_mock_entry, mqtt_client_mock):
...
async def test_one_deprecation_warning_per_platform(hass, mqtt_mock_entry, caplog):
